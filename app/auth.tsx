...
            <TouchableOpacity style={styles.guestButton} onPress={() => router.replace("/(tabs)/(community)")}>
              <Text style={styles.guestButtonText}>Continue as Guest (test the app)</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
...
  guestButton: { marginTop: 30, paddingVertical: 12 },
  guestButtonText: { color: colors.textSecondary, textAlign: "center", fontSize: 15 },
});
